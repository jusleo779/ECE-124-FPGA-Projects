...
![Demo of the Home Energy Monitor on the LogicalStep board](images/energy_monitor_demo.gif)
...
![Functional simulation waveform of the full Energy Monitor system](hvac_system_waveform.png)

*Figure 1: System-level simulation showing `hvac_temp` counting through its range while push buttons (`pb_n`) and switches (`sw`) drive the LED outputs, confirming the integrated comparator, HVAC counter, and control logic behave correctly together.*
